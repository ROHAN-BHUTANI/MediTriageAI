...
def write_manifest(config, df: pd.DataFrame, adapters: dict, start_time: float, output_dir: Path) -> None:
    end_time = time.time()
    ...
    with open(output_dir / "processed" / "build_manifest.json", "w", encoding="utf-8") as f:
