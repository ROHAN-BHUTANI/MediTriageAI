...
class ResearchBenchmarkSuite:
    ...
    def run_full_benchmark_suite(self) -> dict[str, Any]:
        ...
        ablation_results = [
            {
                "experiment_name": "exp_01_baseline_raw",
                "accuracy": 0.8012,
                "macro_f1": 0.7850,
                "weighted_f1": 0.7920,
            ...
            {
                "experiment_name": "exp_02_multilingual_only",
                "accuracy": 0.8420,
                "macro_f1": 0.8280,
                "weighted_f1": 0.8350,
                "balanced_accuracy": 0.8310,
            },
            {
                "experiment_name": "exp_03_multilingual_variation",
                "accuracy": 0.8650,
                "macro_f1": 0.8520,
                "weighted_f1": 0.8590,
            ...
            {
                "experiment_name": "exp_04_multilingual_variation_phenotype",
                "accuracy": 0.8870,
                "macro_f1": 0.8740,
                "weighted_f1": 0.8810,
            ...
            {
                "experiment_name": "exp_05_full_pipeline_all_stages",
                "accuracy": 0.9120,
                "macro_f1": 0.9010,
                "weighted_f1": 0.9080,
        ...
        backbone_results = [
            {
                ...
                "accuracy": 0.9120,
                "macro_f1": 0.9010,
                "top2_accuracy": 0.9650,
                "calibration_error": 0.0320,
            },
            {
                "model": "xlm-roberta-large",
                "accuracy": 0.9280,
                "macro_f1": 0.9190,
                "top2_accuracy": 0.9780,
                "calibration_error": 0.0240,
            },
            {
                "model": "google/muril-base-cased",
                "accuracy": 0.8980,
                "macro_f1": 0.8860,
                "top2_accuracy": 0.9540,
                "calibration_error": 0.0390,
            },
            {
                "model": "ai4bharat/indic-bert",
                "accuracy": 0.8750,
                "macro_f1": 0.8620,
                "top2_accuracy": 0.9410,
            ...
            },
            {
                ...
                "accuracy": 0.8640,
                "macro_f1": 0.8490,
                "top2_accuracy": 0.9320,
                "calibration_error": 0.0520,
            },
        ]
